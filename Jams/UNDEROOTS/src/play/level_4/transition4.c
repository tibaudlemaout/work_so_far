...
void init_transition4(struct_t *all)
{
...
void transition4_display(struct_t *all, sfClock *clock)
{
    ...
    if (seconds > 2) {
        sfText_setString(text, "No time to be horrified by this weird monstrosity,\n\nit was time to stand his ground once more.");
